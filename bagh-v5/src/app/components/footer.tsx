...
export default function Footer() {
    return <div className="max-w-[1440px] w-full flex flex-col md:flex-row flex-wrap lg:flex-nowrap  gap-[25px] lg:gap-[20px] justify-self-center justify-around p-[20px] border-b-1 mx-auto">
        <div className="column1">
            ...
            <ul className="flex flex-nowrap gap-[10px] pt-[20px]">
                <li><Link href="https://bagh.live/af/5pButO62/bagh55"><img src="/Link.png" alt="x" /></Link></li>
                <li><Link href="https://bagh.live/af/5pButO62/bagh55"><img src="/Link-1.png" alt="facebook" /></Link></li>
                <li><Link href="https://bagh.live/af/5pButO62/bagh55"><img src="/Link-2.png" alt="instagram" /></Link></li>
                <li><Link href="https://bagh.live/af/5pButO62/bagh55"><img src="/Link-3.png" alt="linkedin" /></Link></li>
            </ul>
        </div>
